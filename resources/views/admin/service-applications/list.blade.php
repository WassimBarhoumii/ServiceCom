                ...
                <div class="card border-0 shadow mb-4">
                    <div class="card-body card-form">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h3 class="fs-4 mb-1">Service Applications</h3>
                            </div>
                            ...
                            <table class="table ">
                                ...
                                <tbody class="border-0">
                                    @if ($applications->isNotEmpty())
                                        ...
                                        <tr>
                                            <td>
                                                <p>{{ $application->service->title }}</p>
                                               {{-- <p>Applicants: {{ $service->applications->count() }}</p> --}}
                                            </td>
...
<script type="text/javascript">
     function deleteServiceApplication(id) {
        if(confirm("Are you sure you want to delete?")){
            $.ajax({
            url:'{{ route("admin.serviceApplications.destroy") }}',
            type: 'delete',
            data: { id: id },
            dataType: 'json',
            success: function(response) {
                window.location.href = "{{ route('admin.serviceApplications') }}";
            }
         }); 
        }
     }
