            ...
            success: function(response) {
                if (response.status==false) {
                    ...
                    if(errors.confirm_password) {
                        ...
                        $("#confirm_password").removeClass('is-valid').siblings('p').removeClass('invalid-feedback').html('')
                    }

                } else {
                    $("#name").removeClass('is-valid').siblings('p').removeClass('invalid-feedback').html('');

                    $("#email").removeClass('is-valid').siblings('p').removeClass('invalid-feedback').html('');

                    $("#password").removeClass('is-valid').siblings('p').removeClass('invalid-feedback').html('')
